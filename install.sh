...
displayandexec "Installation de netsniff" "$AGI netsniff"
...
displayandexec "Installation de irpas" "$AGI irpas"
...
displayandexec "Installation de galetta" "$AGI galetta"
displayandexec "Installation de guymager" "$AGI guymager"
displayandexec "Installation de magiccrescue" "$AGI magiccrescue"
